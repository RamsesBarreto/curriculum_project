...
<div id="filtrado-container">
    ...
    <div class="title-wrapper">
        ...
        <p>
            Ingresa ya sea el salario, empresa o cargo de trabajo de tu preferencia
        </p>
    </div>
...
<?php while ($row = mysqli_fetch_assoc($result)) { ?>
    ...
    <div class="vacante-card">
        <div class="cardtitle-wrapper">
        <a class="vacante-link" href="detalle_vacante.php?id=<?php echo $row['id'];?>">
            <h2 class="vacante-puesto"><?php echo $row['title'];?></h2>
            <p class="vacante-empresa"><?php echo $row['subtitle'];?></p>
            </div>
            </div>
            <div class="cardparrafo-wrapper">
             <p class="vacante-titulo"><b>Ocupacion:</b> <?php echo $row['job_occupation'];?></p>
...
<!-- <div class="vacante-acciones">
                <a href="editar_vacante.php?id=<?php  ?>" class="btn-editar">Editar</a>
                <a href="eliminar_vacante.php?id=<?php  ?>" class="btn-eliminar" onclick="return confirm('¿Seguro que deseas eliminar esta vacante?');">Eliminar</a>
        </div> -->

<!-- <a href='crear_vacante.php' class='btn-crear'>Crear nueva vacante</a><br><br> -->