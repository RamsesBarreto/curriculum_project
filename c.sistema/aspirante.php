...
if($_SESSION['tipo_usuario'] != 'aspirante') {
...
<div class="carta-container">
                    ...
                    <div class="cartas">
                        <div class="titulo-cartas-wrapper">
                            ...
                            <h3><?php echo ucfirst($_SESSION['nombre']) . ' ' . ucfirst($_SESSION['apellido'])?></h3>
                        </div>
                        <p>Estudiante de Ingeneria de Sistemas</p>
                    </div>
...
<div class="bienvenida-container">
  <div class="bienvenida-wrapper">
                    <h3>Bienvenido Ramses</h3>
                    <p>Gestiona tu perfil, postulate a las ofertas de empleo disponibles, explora las empresas existentes en el sistema y consulta el manual para encontrar las mejores oportunidades laborales.</p>
                </div>
                </div>
...
<div class="content-wrapper">
                ...
                <div class="carta-container">
                    ...
                    <div class="primer-wrapper">
                      <a href="/login-registro/c.sistema/vacantes.php"><div class="cartas">
                            <div class="titulo-cartas-wrapper">
                                <h3>Vacantes</h3>
                                <svg class="img-container" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    fill="currentColor">
                            ...
                            <p>Explora las ofetas laborales disponibles! </p>
                            </div>
                        </div>
                        </a>
                        <a href="">
                        <div class="cartas">
                            ...
                            <p>Perzonaliza tu perfil para destacar y atrae ofertas! </p>
                        </div>
                    </div>
                    </a>
                    ...
                    <div class="segundo-wrapper">
                        <a href="/login-registro/c.sistema/manual.html">
                        <div class="cartas">
                            <div class="titulo-cartas-wrapper">
                                <h3>Manual</h3>
                                <svg class="img-container" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        ...
                        <div class="cartas">
                            ...
                            <p>Descubre las empresas que te estan esperando!</p>
                        </div>
</a>
                    </div>
