...
session_start();
 ...
 if(!isset($_SESSION['rol'])) {
    ...
    window.location = 'nuevacuenta.php';
    </script>";
    session_destroy();
    die();
}
   ...
   <header>
        <div class="container">
            ...
            <nav>
                ...
                <a href="/login-registro/a.inicio/login_register.php">Cerrar Sesion</a>
            </nav>
        </div>
    </header>
                ...
                <div class="carta-container">
                    ...
                    <div class="datos-container">
                        <div class="datos">
                            ...
                            <p>barretoramses2005@gmail.com</p>
                        </div>
                        <div class="datos">
                            <svg class="img-container" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                fill="currentColor">
