    ...
    <section id="personas">
        <div class="container">
            <div class="titulo-wrapper">
                <h2>Lo que los expertos en el campo laboral estan hablando actualmente....</h2>
            </div>
                ...
                <div class="carta-container">
                    ...
                    <div class="carta">
                        <div class="person-wrapper">
                            <img src="../img/Imagen2.jpg" class="img-container primero">
                            <h3>Miguel Angel Leon</h3>
                        </div>
                        <div class="parrafo-wrapper">
                            <p>Hoy los candidatos buscan transparencia y agilidad; una plataforma integrada permite
                                filtrar vacantes con precisión y mejorar la experiencia del postulante.</p>
                        </div>
                    </div>
                    <div class="carta">
                        <div class="person-wrapper">
                            <img src="../img/Imagen1.jpg" class="img-container">
                            <h3>Ana Lucía Fernández</h3>
                        </div>
                        <div class="parrafo-wrapper">
                            <p>La digitalización ha transformado el mercado laboral; una plataforma web centralizada
                                optimiza la conexión entre talento y empresas, reduciendo tiempos y costos</p>
                        </div>
                    </div>
                    <div class="carta">
                        <div class="person-wrapper">
                            <img src="../img/Imagen3.jpg" class="img-container segundo">
                            <h3>Ricardo Alvarado</h3>
                        </div>
                        <div class="parrafo-wrapper">
                            <p>Publicar vacantes en redes o páginas es caro y poco efectivo; una plataforma accesible
                                nivelaría la competencia por talento con las grandes empresas.</p>
                        </div>
                    </div>
                </div>
